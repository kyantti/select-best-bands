...
uv run python -c "import config, split_dataset, ga, train_final, bootstrap, plot_fitness_evolution, check_data, cnn.engine, cnn.data_setup, cnn.model; print('imports OK')"
